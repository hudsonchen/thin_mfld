...
do
  for kernel in gaussian
    do
      ...
      do
      /home/zongchen/miniconda3/envs/thin_mfld/bin/python main.py --dataset covertype --seed $seed --g $g --particle_num $particle_num --step_size 0.01 --noise_scale 0.001 --bandwidth 1.0 --step_num 50 --thinning kt --kernel $kernel
      done
    done
    done
done
